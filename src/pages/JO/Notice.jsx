...
import NoticeS from "../../css/Notice.module.css"
...
function Notice({ isTablet }) {
    ...
    return (
        <div>
            <div>
                <h1 className="text-2xl text-[#656565] font-bold">공지사항</h1>
            </div>
            ...
            <div className="flex flex-wrap items-start gap-4 w-full">
                <div className="bg-white rounded-lg transition-all duration-300 flex-3 pb-4 min-w-[735px]">
                    <div className="flex justify-between items-center p-4">
                        <h1 className="text-[1.25rem] text-[#656565] font-bold">공지사항 리스트</h1>
                        ...
                        <tbody className='text-center'>
                            {pageData.map((user, idx) => (
                                <tr
                                    ...
                                    <td><input type="checkbox" className={`cursor-pointer w-4 h-4 ${NoticeS.checkbox}`} /></td>
                ...
                {selectedUser && (
                    <div className="flex-1 transition-all duration-300">
                        <NoticeDetail user={selectedUser} onClose={() => setSelectedUser(null)} />
                    </div>
                )}
                {showRegister && (
                    <div className="flex-1 transition-all duration-300">
